 ...
 */
package com.lettalk.gy.util.mob.ui.layout;
...
public class TitleLayout {
	...
	private static void createNormal(LinearLayout titleLayout,Context context) {
		...
		inLayout.setBackgroundColor(0xff303537);
				...
				backLayout.setId(cn.smssdk.gui.layout.Res.id.ll_back);
		 ...
		 * 返回
		 */
		LinearLayout.LayoutParams logoParams = new LinearLayout.LayoutParams(cn.smssdk.gui.layout.SizeHelper.fromPx(100), cn.smssdk.gui.layout.SizeHelper.fromPx(100));
		logoParams.gravity = Gravity.CENTER_VERTICAL;
		logoParams.rightMargin = cn.smssdk.gui.layout.SizeHelper.fromPx(10);
		ImageView backLogo = new ImageView(context);
		backLogo.setLayoutParams(logoParams);
		//返回LOGO图片
		backLogo.setBackgroundResource(com.lettalk.gy.R.mipmap.ic_launcher);
		...
		backLayout.addView(backArrow);
				...
				title.setId(cn.smssdk.gui.layout.Res.id.tv_title);
	...
	private static void createSearch(LinearLayout titleLayout,Context context) {
		...
		innerTitleLayout.setId(cn.smssdk.gui.layout.Res.id.llTitle);
		...
		searchImage.setId(cn.smssdk.gui.layout.Res.id.ivSearch);
		...
		innerSearchLayout.setId(cn.smssdk.gui.layout.Res.id.llSearch);
		...
		identify.setId(cn.smssdk.gui.layout.Res.id.et_put_identify);
		...
		clear.setId(cn.smssdk.gui.layout.Res.id.iv_clear);
