...
public class GsonTools {
	...
	public static <FunctionItem> List<FunctionItem> changeGsonToFunList(String gsonString,
	...
	public static <ChildNewsCate> List<ChildNewsCate> changeGsonToCateList(String gsonString,
