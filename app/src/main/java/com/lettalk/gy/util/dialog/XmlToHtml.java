package com.lettalk.gy.util.dialog;
...
public class XmlToHtml {
    static final private String TAG = "XmlToHtml";

    static final private String TITLE_CHANGELOG = "title_changelog";
    static final private String CHANGELOG_XML = "about";

    private Activity fActivity;

    public XmlToHtml(Activity context) {
        fActivity = context;
    }
    ...
    private String GetHTMLVersion(int aResourceId, Resources aResource) {
...
//        _Title = _Title + " v" + GetAppVersion();
        ...
        String _HTML = GetHTMLVersion(_resID, _Resource);
