...
import cn.smssdk.gui.layout.DrawableHelper;
...
public class ContactsListviewItemLayout {
	...
	public static RelativeLayout create(Context context) {
		...
		root.setId(cn.smssdk.gui.layout.Res.id.rl_lv_item_bg);
		...
		contactImage.setId(cn.smssdk.gui.layout.Res.id.iv_contact);
		...
		wrapperParams.addRule(RelativeLayout.RIGHT_OF, cn.smssdk.gui.layout.Res.id.iv_contact);
		...
		name.setId(cn.smssdk.gui.layout.Res.id.tv_name);
		...
		contact.setId(cn.smssdk.gui.layout.Res.id.tv_contact);
		...
		add.setId(cn.smssdk.gui.layout.Res.id.btn_add);
