...
public class SendMsgDialogLayout {
	...
	public static LinearLayout create(Context context) {
		...
		dialogTitle.setId(cn.smssdk.gui.layout.Res.id.tv_dialog_title);
		...
		dialogHint.setId(cn.smssdk.gui.layout.Res.id.tv_dialog_hint);
		...
		phone.setId(cn.smssdk.gui.layout.Res.id.tv_phone);
		...
		ok.setId(cn.smssdk.gui.layout.Res.id.btn_dialog_ok);
		...
		cancel.setId(cn.smssdk.gui.layout.Res.id.btn_dialog_cancel);
