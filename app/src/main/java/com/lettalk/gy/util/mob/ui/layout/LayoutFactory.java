...
public class LayoutFactory
{
	...
	static ViewGroup create(Context context,String name) {
		...
		{
			cn.smssdk.gui.layout.ContactListPageLayout page = new cn.smssdk.gui.layout.ContactListPageLayout(context);
			v = page.getLayout();
		}
		...
		{
			cn.smssdk.gui.layout.CountryListPageLayout page = new CountryListPageLayout(context);
			v = page.getLayout();
		}
		else if(name.equals("smssdk_input_identify_num_page"))
		{
			cn.smssdk.gui.layout.IdentifyNumPageLayout page = new IdentifyNumPageLayout(context);
			v = page.getLayout();
		}
		...
		{
			cn.smssdk.gui.layout.RegisterPageLayout layout = new RegisterPageLayout(context);
			v = layout.getLayout();
		}
