 ...
 */
package com.lettalk.gy.util.mob.ui;
...
import cn.smssdk.gui.ContactEntry;
...
public class ContactsPage extends FakeActivity implements OnClickListener, TextWatcher{
	...
	private cn.smssdk.gui.ContactsListView listView;
	private cn.smssdk.gui.ContactsAdapter adapter;
	private cn.smssdk.gui.ContactItemMaker itemMaker;
	...
	public void onCreate() {
		...
		// 初始化搜索引擎
		cn.smssdk.gui.SearchEngine.prepare(activity, new Runnable() {
			public void run() {
				afterPrepare();
			}
		});
