...
import com.lettalk.gy.util.mob.ui.layout.RegisterPageLayout;
import com.lettalk.gy.util.mob.ui.layout.SendMsgDialogLayout;
...
public class RegisterPage extends FakeActivity implements OnClickListener,
	...
	private void afterVerificationCodeRequested(boolean smart) {
		...
		if(smart) {
			...
			cn.smssdk.gui.IdentifyNumPage page = new cn.smssdk.gui.IdentifyNumPage();
