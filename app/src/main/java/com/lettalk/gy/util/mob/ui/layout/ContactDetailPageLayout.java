...
public class ContactDetailPageLayout extends BasePageLayout {
	...
	protected void onCreateContent(LinearLayout parent) {
		...
		contactIcon.setId(cn.smssdk.gui.layout.Res.id.iv_contact_icon);
		...
		contactName.setId(cn.smssdk.gui.layout.Res.id.tv_contact_name);
		...
		contactPhone.setId(cn.smssdk.gui.layout.Res.id.tv_contact_phones);
		...
		tv.setId(cn.smssdk.gui.layout.Res.id.tv_invite_hint);
