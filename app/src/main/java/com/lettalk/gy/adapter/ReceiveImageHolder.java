...
public class ReceiveImageHolder extends BaseViewHolder {
  ...
  public void bindData(Object o) {
    ...
    //显示图片
    ViewUtil.setPicture(message.getRemoteUrl(), R.mipmap.ic_launcher, iv_picture,new ImageLoadingListener(){
      @Override
    ...
    iv_picture.setOnLongClickListener(new View.OnLongClickListener() {
      ...
      public boolean onLongClick(View v) {
        if (onRecyclerViewListener != null) {
          ...
          onRecyclerViewListener.onItemLongClick(getAdapterPosition(), v, ReceiveImageHolder.this);
        }
        return true;
      }
    });
